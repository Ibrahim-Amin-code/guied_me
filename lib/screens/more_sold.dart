...
import 'package:guied_me/generated/locale_keys.g.dart';
import 'package:guied_me/model/books.dart';
                    ...
                    return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return moreSoldCard(
                              ...
                              h: h,
                              bookName:(lang == 'en')?
                  snapshot.data.data[index].nameEn.toString():snapshot.data.data[index].nameAr.toString(),
                              writerName:
                              (lang == 'en')?  snapshot.data.data[index].writerEn.toString(): snapshot.data.data[index].writerAr.toString(),
