...
import 'package:guied_me/DBhelper/AppCubit/appState.dart';
import 'package:guied_me/DBhelper/AppCubit/cubit.dart';
          ...
          Stack(
            children: [
              buildBookDetailCard(
                  ...
                  w: w,
                  context: context,
                  bookname:  (lang == 'en')? widget.details.nameEn.toString() : widget.details.nameAr.toString(),
